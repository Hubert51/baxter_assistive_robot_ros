...
serial_port_name_imu1="/dev/ttyACM1"
serial_port_name_imu2="/dev/ttyACM0"
...
def talker():
    imu1Gateway = NrfImuInterface(serial_port_name_imu1)
    imu2Gateway = NrfImuInterface(serial_port_name_imu2)
    ...
    while not rospy.is_shutdown():
        ...
        buildImuMsg(imu1Gateway.IMU1_read(), imu1Msg)
        buildImuMsg(imu2Gateway.IMU2_read(), imu2Msg)
