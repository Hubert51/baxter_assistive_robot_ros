...
property double[] vacuum_sensor_value
...
class BaxterPeripherals_impl(object):
    ...
    @property
    def vacuum_sensor_value(self):
        self._vacuum_sensor_value[0] = self._l_vacuum_sensor.state()
        self._vacuum_sensor_value[1] = self._r_vacuum_sensor.state()
        return self._vacuum_sensor_value
